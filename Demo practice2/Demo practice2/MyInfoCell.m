...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        self.label = [[UILabel alloc] initWithFrame:CGRectMake(90, 25, 200, 30)];
        self.label.text = @"Lilililalila";
        [self.contentView addSubview:self.label];
        
        
        self.MyimageView = [[UIImageView alloc] initWithFrame:CGRectMake(15, 10, 60, 60)];
